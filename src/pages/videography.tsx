...
export default function VideoEditingHero() {
    return (
        <section
            ...
            style={{
                backgroundImage:
                    "url('https://i.ibb.co/gMbYrRdM/video.png')",
            }}
        >
            {/* Bottom-left black gradient overlay */}
            ...
            >
                ...
                <p className="text-xl md:text-2xl text-gray-200">
                    From promos and ads to reels and motion graphics, we deliver cinematic video editing tailored for digital engagement and brand storytelling.
                </p>
                <Link
                    to="/book-call"
