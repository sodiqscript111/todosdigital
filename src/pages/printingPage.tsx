...
import WorkShowcase from "../component/workshowcase.tsx";
    ...
    return (
        <>
            ...
            <section
                ...
                style={{
                    backgroundImage:
                        "url('https://i.ibb.co/kgCs62Yn/printing.png')",
                }}
            >
                {/* Gradient Overlay */}
                ...
                >
                    ...
                    <p className="text-xl md:text-2xl text-gray-200">
                        From custom t-shirts and branded stationery to premium product packaging,
                        we help you bring your brand to life in the real world with high-impact print and merchandise designs.
                    </p>
                    <Link
                        to="/book-call"
            ...
            {/* Work Showcase Section - now below the hero */}
            <WorkShowcase />
        </>
    );
}
